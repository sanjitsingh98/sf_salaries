...
#print(df[df['JobTitle'].apply(lambda x: police_string(x))].groupby("Year")["OvertimePay"].mean())
#print(df[df['JobTitle'].apply(lambda x: chief_string(x))]["JobTitle"].value_counts().head(10))
#print(df[df['JobTitle'].apply(lambda x: police_string(x))]["JobTitle"].value_counts().head(10))
